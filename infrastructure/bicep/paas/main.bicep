...
output appInsightsConnectionString string = paasResources.outputs.appInsightsConnectionString
output appServiceManagedIdentityPrincipalId string = paasResources.outputs.appServiceManagedIdentityPrincipalId
output appServiceDefaultHostName string = paasResources.outputs.appServiceDefaultHostName
output appServiceUrl string = paasResources.outputs.appServiceUrl
